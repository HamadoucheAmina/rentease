...
?>
	...
	<section>
        <div >
            <p class="reservations-heading">Historique</p><style>
    p.reservations-heading {
        font-size: 28px; /* Taille de la police */
        color: red; /* Couleur du texte */
        text-align: center; /* Alignement au centre */
        margin-top: 20px; /* Marge en haut pour l'écart par rapport aux éléments précédents */
        margin-bottom: 20px; /* Marge en bas pour l'écart par rapport aux éléments suivants */
    }
</style>
            <?php
